...
<div class="top">
      ...
      <div class="mid">
      <form  action="Job-single.php" method="POST" name="home1" onsubmit="return validateForm()" autocomplete="On">
      <button type="button" class="btn btn-primary">Search a Job...</button>
        <div class="form-row align-items-center">
          <div class="col-auto my-1">
            <input type="text" name="search" class="form-control form-control-block search-input"  placeholder="Eg: Full Stack Developer" >
          </div><pre>   </pre>
          <div class="col-auto my-1">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                      ...
                      $outputLogo = $row["Logo"];
                       ...
                       echo '<div class="recent" ><div class="row">
                       <div class="col-md-12">
                         <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                            <img src="'.$outputLogo.'"  alt="LOGO" style="width:100px;height:60px" class="slogo">
                            <div class="mb-4 mb-md-0 mr-5">
                             <div class="job-post-item-header d-flex align-items-center">
                               <h2 class="mr-3 text-black h4">' . $row["Job_Title"] .'</h2>
                               <div class="badge-wrap">
                                <span class="btn btn-success">'. $row["Job_Type"] . '</span>
                               </div>
                             </div>
                            ...
                            <div class="ml-auto">
                            <form action="ClickSearch.php" method="POST">
                            <a href="" class="btn btn-danger rounded-circle btn-favorite active"><span class="icon-heart"></span></a>
                              <input type="radio"  name="Topi" value="'.$Bno.'" checked>
                              <input type="Submit" class="btn btn-primary py-2" name="submit" value="See more...">
                            </form>
                            </div>
